 ...
 */
public class LocationFilterDialogActivity extends HonarnamaBrowseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivity = LocationFilterDialogActivity.this;
        ...
        final IconicsDrawable unCheckedDrawable = new IconicsDrawable(LocationFilterDialogActivity.this)
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    mAllIranCheckBox.setButtonDrawable(
                            new IconicsDrawable(LocationFilterDialogActivity.this)
        ...
        city.getAllCitiesSorted(mSelectedProvinceId).continueWith(new Continuation<TreeMap<Number, HashMap<Integer, String>>, Object>() {
            ...
            public Object then(Task<TreeMap<Number, HashMap<Integer, String>>> task) throws Exception {
                if (task.isFaulted()) {
                    ...
                    mCityEditEext.setHint(LocationFilterDialogActivity.this.getString(R.string.error_getting_info));
        ...
        provinces.getAllProvincesSorted().
                continueWith(new Continuation<TreeMap<Number, Province>, Object>() {
                    ...
                    public Object then(Task<TreeMap<Number, Province>> task) throws Exception {
                        if (task.isFaulted()) {
                            mRefetchProvinces.setVisibility(View.VISIBLE);
                            mRefetchCities.setVisibility(View.VISIBLE);
                            mProvinceEditText.setHint(LocationFilterDialogActivity.this.getString(R.string.error_getting_info));
                            logE("Getting Province Task Failed. Msg: " + task.getError().getMessage() + " // Error: " + task.getError(), task.getError());
                            Toast.makeText(LocationFilterDialogActivity.this, getString(R.string.error_getting_province_list) + getString(R.string.check_net_connection), Toast.LENGTH_SHORT).show();
                        } else {
            ...
            public Object then(Task<TreeMap<Number, HashMap<Integer, String>>> task) throws Exception {
                ...
                if (task.isFaulted() && mSelectedProvinceId > 0) {
                    ...
                    Toast.makeText(LocationFilterDialogActivity.this, getString(R.string.error_getting_city_list) + getString(R.string.check_net_connection), Toast.LENGTH_SHORT).show();
                } else {
                    mCityOrderedTreeMap = task.getResult();
