 ...
 *         &quot;Fetched! Data length: &quot; + data.length + &quot;, or exception: &quot; +
 * e.getMessage());
 *   }
 * });
 * </pre>
...
public class ParseImageView extends ImageView {
     ...
     *
     * @param placeholder A {@code Drawable} to be displayed while the remote image data is being
     *                    fetched. This
     *                    value can be null, and this {@code ImageView} will simply be blank while
     *                    data is
     *                    fetched.
     */
