...
public class Province extends ParseObject {
    ...
    public static void cacheProvinces(final Context context, final SharedPreferences sharedPref) {

        Toast.makeText(context, "cacheProvinces", Toast.LENGTH_SHORT).show();
